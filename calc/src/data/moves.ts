...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  Acid: {target: 'allAdjacentFoes', category: 'Special'},
  'Ancient Power': {makesContact: true, category: 'Special'},
  Bide: {makesContact: true, category: 'Physical'},
  Bind: {makesContact: true, category: 'Physical'},
  Blizzard: {target: 'allAdjacentFoes', category: 'Special'},
  Clamp: {makesContact: true, category: 'Physical'},
  'Comet Punch': {makesContact: true, category: 'Physical'},
  Counter: {makesContact: true, category: 'Physical'},
  Crunch: {makesContact: true, category: 'Physical'},
  Detect: {priority: 3},
  Endure: {priority: 4},
  Protect: {priority: 3},
  Dig: {makesContact: true, category: 'Physical'},
  'Double Kick': {makesContact: true, category: 'Physical'},
  'Double Slap': {makesContact: true, category: 'Physical'},
  Explosion: {target: 'allAdjacent', category: 'Physical'},
  Flail: {makesContact: true, category: 'Physical'},
  Fly: {makesContact: true, category: 'Physical'},
  'Fury Attack': {makesContact: true, category: 'Physical'},
  'Fury Swipes': {makesContact: true, category: 'Physical'},
  'High Jump Kick': {makesContact: true, category: 'Physical'},
  'Jump Kick': {makesContact: true, category: 'Physical'},
  'Leech Life': {makesContact: true, category: 'Physical'},
  Outrage: {makesContact: true, category: 'Physical'},
  'Petal Dance': {makesContact: true, category: 'Special'},
  Pursuit: {makesContact: true, category: 'Physical'},
  Rage: {makesContact: true, category: 'Physical'},
  'Rapid Spin': {makesContact: true, category: 'Physical'},
  'Razor Wind': {target: 'allAdjacentFoes', category: 'Special'},
  Reversal: {makesContact: true, category: 'Physical'},
  'Rock Smash': {makesContact: true, category: 'Physical'},
  'Self-Destruct': {target: 'allAdjacent', category: 'Physical'},
  'Skull Bash': {makesContact: true, category: 'Physical'},
  Stomp: {makesContact: true, category: 'Physical'},
  Struggle: {makesContact: true, category: 'Physical'},
  Surf: {target: 'allAdjacentFoes', category: 'Special'},
  Thief: {makesContact: true, category: 'Physical'},
  Thrash: {makesContact: true, category: 'Physical'},
  'Triple Kick': {makesContact: true, multihit: 3, category: 'Physical'},
  'Vine Whip': {makesContact: true, category: 'Physical'},
  Waterfall: {makesContact: true, category: 'Physical'},
  Wrap: {makesContact: true, category: 'Physical'},
  Crabhammer: {makesContact: true, category: 'Physical'},
  'Double-Edge': {recoil: [1, 3], makesContact: true, category: 'Physical'},
  Earthquake: {target: 'allAdjacent', category: 'Physical'},
  'Extreme Speed': {makesContact: true, category: 'Physical'},
  'Fury Cutter': {makesContact: true, category: 'Physical'},
  'Heal Bell': {isSound: true},
  Magnitude: {target: 'allAdjacent', category: 'Physical'},
  Roar: {isSound: true},
  Submission: {makesContact: true, category: 'Physical'},
  Tackle: {makesContact: true, category: 'Physical'},
  'Take Down': {makesContact: true, category: 'Physical'},
  Twister: {target: 'allAdjacentFoes', category: 'Special'},
  'Body Slam': {makesContact: true, category: 'Physical'},
  Bubble: {target: 'allAdjacentFoes', category: 'Special'},
  Growl: {isSound: true, target: 'allAdjacentFoes'},
  Lick: {makesContact: true, category: 'Physical'},
  'Perish Song': {isSound: true},
  Screech: {isSound: true},
  Sing: {isSound: true},
  Snore: {isSound: true, category: 'Special'},
  'String Shot': {target: 'allAdjacentFoes'},
  Supersonic: {isSound: true},
  'Sweet Scent': {target: 'allAdjacentFoes'},
  Rollout: {makesContact: true, category: 'Physical'},
  Constrict: {makesContact: true, category: 'Physical'},
  'Dizzy Punch': {makesContact: true, category: 'Physical'},
  Frustration: {makesContact: true, category: 'Physical'},
  'Hyper Fang': {makesContact: true, category: 'Physical'},
  'Karate Chop': {makesContact: true, category: 'Physical'},
  'Low Kick': {bp: 0, makesContact: true, category: 'Physical'},
  Return: {makesContact: true, category: 'Physical'},
  'Rolling Kick': {makesContact: true, category: 'Physical'},
  Bite: {makesContact: true, category: 'Physical'},
  'Cross Chop': {makesContact: true, category: 'Physical'},
  Cut: {makesContact: true, category: 'Physical'},
  'Drill Peck': {makesContact: true, category: 'Physical'},
  'Dynamic Punch': {makesContact: true, category: 'Physical'},
  'False Swipe': {makesContact: true, category: 'Physical'},
  'Fire Punch': {makesContact: true, category: 'Physical'},
  'Flame Wheel': {makesContact: true, category: 'Physical'},
  Guillotine: {makesContact: true, category: 'Physical'},
  Headbutt: {makesContact: true, category: 'Physical'},
  'Horn Attack': {makesContact: true, category: 'Physical'},
  'Horn Drill': {makesContact: true, category: 'Physical'},
  'Ice Punch': {makesContact: true, category: 'Physical'},
  'Icy Wind': {target: 'allAdjacentFoes', category: 'Special'},
  'Iron Tail': {makesContact: true, category: 'Physical'},
  Leer: {target: 'allAdjacentFoes'},
  'Mach Punch': {makesContact: true, category: 'Physical'},
  Megahorn: {makesContact: true, category: 'Physical'},
  'Mega Kick': {makesContact: true, category: 'Physical'},
  'Mega Punch': {makesContact: true, category: 'Physical'},
  'Metal Claw': {makesContact: true, category: 'Physical'},
  Peck: {makesContact: true, category: 'Physical'},
  Pound: {makesContact: true, category: 'Physical'},
  'Powder Snow': {target: 'allAdjacentFoes', category: 'Special'},
  'Quick Attack': {makesContact: true, category: 'Physical'},
  'Razor Leaf': {target: 'allAdjacentFoes', category: 'Physical'},
  'Rock Slide': {target: 'allAdjacentFoes', category: 'Physical'},
  Scratch: {makesContact: true, category: 'Physical'},
  'Seismic Toss': {makesContact: true, category: 'Physical'},
  'Shadow Strike': {makesContact: true, category: 'Physical'},
  Slam: {makesContact: true, category: 'Physical'},
  Slash: {makesContact: true, category: 'Physical'},
  Spark: {makesContact: true, category: 'Physical'},
  'Steel Wing': {makesContact: true, category: 'Physical'},
  Strength: {makesContact: true, category: 'Physical'},
  'Super Fang': {makesContact: true, category: 'Physical'},
  Swift: {target: 'allAdjacentFoes', category: 'Special'},
  'Tail Whip': {target: 'allAdjacentFoes'},
  'Thunder Punch': {makesContact: true, category: 'Physical'},
  'Vise Grip': {makesContact: true, category: 'Physical'},
  'Vital Throw': {makesContact: true, category: 'Physical'},
  'Wing Attack': {makesContact: true, category: 'Physical'},
  'Arm Thrust': {
    bp: 15,
    type: 'Fighting',
    multihit: [2, 5],
  ...
  Astonish: {bp: 30, type: 'Ghost', makesContact: true, category: 'Physical'},
  Block: {bp: 0, category: 'Status', type: 'Normal'},
  Bounce: {bp: 85, type: 'Flying', makesContact: true, category: 'Physical'},
  'Bullet Seed': {bp: 10, type: 'Grass', multihit: [2, 5], category: 'Physical'},
  Camouflage: {bp: 0, category: 'Status', type: 'Normal'},
  Charge: {bp: 0, category: 'Status', type: 'Electric'},
  Covet: {bp: 40, type: 'Normal', category: 'Physical'},
  Dive: {bp: 60, type: 'Water', makesContact: true, category: 'Physical'},
  'Doom Desire': {bp: 120, type: 'Steel', category: 'Special'},
  Extrasensory: {bp: 80, type: 'Psychic', category: 'Special'},
  'Fake Out': {bp: 40, type: 'Normal', priority: 1, category: 'Physical'},
  'Follow Me': {bp: 0, category: 'Status', type: 'Normal', priority: 3},
  Hail: {bp: 0, category: 'Status', type: 'Ice'},
  'Icicle Spear': {bp: 10, type: 'Ice', multihit: [2, 5], category: 'Physical'},
  Ingrain: {bp: 0, category: 'Status', type: 'Grass'},
  'Knock Off': {bp: 20, type: 'Dark', makesContact: true, category: 'Physical'},
  'Leaf Blade': {bp: 70, type: 'Grass', makesContact: true, category: 'Physical'},
  ...
  'Needle Arm': {bp: 60, type: 'Grass', makesContact: true, category: 'Physical'},
  'Odor Sleuth': {bp: 0, category: 'Status', type: 'Normal'},
  Overheat: {bp: 140, type: 'Fire', self: {boosts: {spa: -2}}, makesContact: true, category: 'Special'},
  Revenge: {bp: 60, type: 'Fighting', makesContact: true, category: 'Physical'},
  'Rock Blast': {bp: 25, type: 'Rock', multihit: [2, 5], category: 'Physical'},
  'Role Play': {bp: 0, category: 'Status', type: 'Psychic'},
  'Sand Tomb': {bp: 15, type: 'Ground', category: 'Physical'},
  'Skill Swap': {bp: 0, category: 'Status', type: 'Psychic'},
  'Smelling Salts': {bp: 60, type: 'Normal', makesContact: true, category: 'Physical'},
  ...
  Uproar: {bp: 50, type: 'Normal', isSound: true, category: 'Special'},
  'Volt Tackle': {bp: 120, type: 'Electric', recoil: [1, 3], makesContact: true, category: 'Physical'},
  'Weather Ball': {bp: 50, type: 'Normal', category: 'Special'},
  Aromatherapy: {bp: 0, category: 'Status', type: 'Grass'},
  'Brick Break': {bp: 75, type: 'Fighting', makesContact: true, category: 'Physical'},
  Endeavor: {bp: 0, type: 'Normal', makesContact: true, category: 'Physical'},
  'Focus Punch': {bp: 150, type: 'Fighting', makesContact: true, category: 'Physical'},
  ...
  'Sky Uppercut': {bp: 85, type: 'Fighting', makesContact: true, category: 'Physical'},
  ...
  'Air Cutter': {bp: 55, type: 'Flying', target: 'allAdjacentFoes', category: 'Special'},
  Facade: {bp: 70, type: 'Normal', makesContact: true, category: 'Physical'},
  'Grass Whistle': {bp: 0, category: 'Status', type: 'Grass', isSound: true},
  'Heat Wave': {bp: 100, type: 'Fire', target: 'allAdjacentFoes', category: 'Special'},
  'Hyper Voice': {bp: 90, type: 'Normal', isSound: true, target: 'allAdjacentFoes', category: 'Special'},
  'Metal Sound': {bp: 0, category: 'Status', type: 'Steel', isSound: true},
  'Meteor Mash': {bp: 100, type: 'Steel', makesContact: true, category: 'Physical'},
  'Muddy Water': {bp: 95, type: 'Water', target: 'allAdjacentFoes', category: 'Special'},
  'Poison Fang': {bp: 50, type: 'Poison', makesContact: true, category: 'Physical'},
  'Rock Tomb': {bp: 50, type: 'Rock', category: 'Physical'},
  'Will-O-Wisp': {bp: 0, category: 'Status', type: 'Fire'},
  'Ice Ball': {bp: 30, type: 'Ice', makesContact: true, category: 'Physical'},
  ...
  'Psycho Boost': {bp: 140, type: 'Psychic', self: {boosts: {spa: -2}}, category: 'Special'},
  ...
  'Aerial Ace': {bp: 60, type: 'Flying', makesContact: true, category: 'Physical'},
  'Blast Burn': {bp: 150, type: 'Fire', category: 'Special'},
  'Blaze Kick': {bp: 85, type: 'Fire', makesContact: true, category: 'Physical'},
  ...
  'Crush Claw': {bp: 75, type: 'Normal', makesContact: true, category: 'Physical'},
  'Dragon Claw': {bp: 80, type: 'Dragon', makesContact: true, category: 'Physical'},
  'Dragon Dance': {bp: 0, category: 'Status', type: 'Dragon'},
  Eruption: {bp: 150, type: 'Fire', target: 'allAdjacentFoes', category: 'Special'},
  ...
  'Poison Tail': {bp: 50, type: 'Poison', makesContact: true, category: 'Physical'},
  'Shadow Punch': {bp: 60, type: 'Ghost', makesContact: true, category: 'Physical'},
  'Shock Wave': {bp: 60, type: 'Electric', category: 'Special'},
  Superpower: {bp: 120, type: 'Fighting', self: {boosts: {atk: -1, def: -1}}, makesContact: true, category: 'Physical'},
  'Water Pulse': {bp: 60, type: 'Water', category: 'Special'},
  'Water Spout': {bp: 150, type: 'Water', target: 'allAdjacentFoes', category: 'Special'},
  ...
  'Feint Attack': {category: 'Physical'},
